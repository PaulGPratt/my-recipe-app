...
INSERT INTO recipe (
    ...
    '65g (1/3 cup) bubbly, active starter, 300g (1 1/4 cups) warm water, 12g (1 tbsp) sugar, 15g (1 tbsp) oil, plus more for coating the pan, 400g (3 1/3 cups) bread flour, 100g (3/4 cup plus 1 tbsp) all-purpose flour, 9g (1 1/2 tsp) fine sea salt',
