// Code generated by the Encore v1.41.8 client generator. DO NOT EDIT.
...
export function Environment(name: string): BaseURL {
    return `https://${name}-my-recipe-app-3p6i.encr.app`
}
...
/**
 * Client is an API client for the my-recipe-app-3p6i Encore application.
 */
...
class BaseClient {
    ...
    constructor(baseURL: string, options: ClientOptions) {
        ...
        if (typeof window === "undefined") {
            this.headers["User-Agent"] = "my-recipe-app-3p6i-Generated-TS-Client (Encore/v1.41.8)";
        }
