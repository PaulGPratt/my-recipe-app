                ...
                <Card className="rounded-none">
                    ...
                    <CardContent className="px-4">
                        ...
                        <div className="flex flex-col flex-grow items-start gap-2 transition-all">
                            ...
                            <div className="text-3xl font-semibold">Instructions</div>
                            <ReactQuill
                                key={isEditMode ? 'edit-instructions' : 'read-instructions'} // Force rerender on mode change
                                defaultValue={instructions} // Use defaultValue for initial content
